...
def functionForm():
    ...
    def checkForm():
        ...
        telNumberCheck = StrVarTelNumber.get()
        ...
        if len(emptyList) > 0:
            ...
            userCodeLabel = tk.Label(
                root,
                text = "registratiecode: " + str(dataTitle),
                font = ("Arial", 12)
            )
    ...
    StrVarTelNumber = tk.StringVar()
    entryTelNumber = tk.Entry(
        frameForm,
        textvariable = StrVarTelNumber,
        font = ("Arial", 12),
        width = 25
    )    
